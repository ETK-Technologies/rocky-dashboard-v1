...
import { Crown, Shield, Database, Lock, Zap, AlertTriangle } from "lucide-react";
      ...
      <PageContainer>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-red-700 dark:text-red-300 mt-1">
                You have unrestricted access to all system functions. Changes made here
                can affect the entire application. All actions are permanently logged and
                audited.
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="p-4 bg-white dark:bg-gray-800 rounded-lg shadow">
            ...
            <div className="text-xl font-bold text-gray-900 dark:text-white">2.4 GB</div>
          </div>
          <div className="p-4 bg-white dark:bg-gray-800 rounded-lg shadow">
            <div className="text-xs text-gray-600 dark:text-gray-400 uppercase">
              API Calls Today
            </div>
            <div className="text-xl font-bold text-gray-900 dark:text-white">45.2K</div>
          </div>
          <div className="p-4 bg-white dark:bg-gray-800 rounded-lg shadow">
            <div className="text-xs text-gray-600 dark:text-gray-400 uppercase">
              Active Admins
        ...
        <div className="mt-8 p-6 bg-white dark:bg-gray-800 rounded-lg shadow">
          ...
          <div className="space-y-3">
            {[
              ...
              { action: "System configuration updated", time: "2 hours ago", type: "warning" },
              { action: "Security audit passed", time: "6 hours ago", type: "success" },
            ].map((activity, index) => (
              <div
                key={index}
