...
import { PageContainer, PageHeader, Tabs, TabsList, TabsTrigger, TabsContent, LoadingState } from "@/components/ui";
...
export default function RolesAndPermissionsPage() {
  return (
    <Suspense fallback={<PageContainer><LoadingState /></PageContainer>}>
