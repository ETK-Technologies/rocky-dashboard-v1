...
export function StorageSettings() {
    ...
    if (loading) {
        return (
            <LoadingState
                message="Loading storage settings..."
                loading={loading}
                fullScreen={true}
            />
        );
        ...
        <div className="space-y-6">
            ...
            <CustomCard>
                <CustomCardHeader>
                    ...
                    <CustomCardDescription>
                        Configure storage provider credentials and upload
                        constraints.
                    </CustomCardDescription>
                </CustomCardHeader>
                <CustomCardContent>
                    ...
                    >
                        ...
                        <TabsContent value="general" className="space-y-6 mt-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium mb-2 text-foreground">
                                    Allowed File Types (comma-separated MIME
                                    types)
                                </label>
                                <CustomInput
                                    value={
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="mt-1 text-xs sm:text-sm text-muted-foreground">
                                        Current:{" "}
                                        {formatFileSize(formData.maxFileSize)}
                                    </p>
                                </div>
                            ...
                            {formData.storageProvider === "r2" && (
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <CustomInput
                                            value={
                                                formData.cloudflareR2AccountId ||
                                                ""
                                            }
                                            onChange={(e) =>
                                                handleChange(
                                    ...
                                    <div>
                                        ...
                                        <CustomInput
                                            value={
                                                formData.cloudflareR2AccessKeyId ||
                                                ""
                                            }
                                            onChange={(e) =>
                                                handleChange(
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <CustomInput
                                                ...
                                                value={
                                                    formData.cloudflareR2SecretAccessKey ||
                                                    ""
                                                }
                                                onChange={(e) =>
                                                    handleChange(
                                    ...
                                    <div>
                                        ...
                                        <CustomInput
                                            value={
                                                formData.cloudflareR2BucketName ||
                                                ""
                                            }
                                            onChange={(e) =>
                                                handleChange(
                                    ...
                                    <div>
                                        ...
                                        <CustomInput
                                            value={
                                                formData.cloudflareR2PublicUrl ||
                                                ""
                                            }
                                            onChange={(e) =>
                                                handleChange(
                        ...
                        <TabsContent value="debug" className="space-y-4 mt-6">
                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0">
                                <p className="text-sm text-muted-foreground">
                                    View diagnostic information about stored
                                    credentials
                                </p>
                                <CustomButton
                                    variant="outline"
                        ...
                        onClick={() => {
                            if (settings) {
                                setFormData((prev) => ({
                                    ...prev,
                                    ...settings,
                                    allowedFileTypes: Array.isArray(
                                        settings.allowedFileTypes
                                    )
                                        ? settings.allowedFileTypes
                                        : [],
