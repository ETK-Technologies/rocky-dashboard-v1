    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (submitData.storageProvider === "local") {
                ...
                cleanedData.cloudflareR2AccountId =
                    submitData.cloudflareR2AccountId;
                cleanedData.cloudflareR2BucketName =
                    submitData.cloudflareR2BucketName;
                cleanedData.cloudflareR2PublicUrl =
                    submitData.cloudflareR2PublicUrl;
            } else if (submitData.storageProvider === "cdn") {
                cleanedData.bunnyCdnStorageZone =
                    submitData.bunnyCdnStorageZone;
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <CustomCard>
                    ...
                    <CustomCardContent className="space-y-4">
                        <div>
                            <CustomLabel htmlFor="storageProvider">
                                Provider
                            </CustomLabel>
                            <select
                                id="storageProvider"
                            ...
                            <CustomCardContent className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <CustomInput
                                        ...
                                        value={
                                            formValues.cloudflareR2BucketName
                                        }
                                        onChange={handleChange}
                    ...
                    <>
                        <CustomCard>
                            ...
                            <CustomCardContent className="space-y-4">
                                ...
                                <div>
                                    <CustomLabel htmlFor="bunnyCdnHostname">
                                        Hostname
                                    </CustomLabel>
                                    <CustomInput
                                        id="bunnyCdnHostname"
                                ...
                                <div>
                                    <CustomLabel htmlFor="bunnyCdnRegion">
                                        Region
                                    </CustomLabel>
                                    <select
                                        id="bunnyCdnRegion"
                    ...
                    <CustomCardContent className="space-y-4">
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground mt-1">
                                {(formValues.maxFileSize / 1024 / 1024).toFixed(
                                    2
                                )}{" "}
                                MB
                            </p>
