...
export default function OrderDetails({ orderId }) {
    ...
    const [paymentDetailsModalOpen, setPaymentDetailsModalOpen] =
        useState(false);
    ...
    const customerNotes = useMemo(
        () =>
            orderNotes.filter(
                (note) =>
                    (note?.authorType || "").toString().toUpperCase() ===
                        "CUSTOMER" || note?.isInternal === false
            ),
        [orderNotes]
    );
    ...
    const paymentMethodSummary = useMemo(() => {
        ...
        if (paymentMethod) {
            ...
            if (
                paymentMethod.type &&
                !summaryParts.includes(paymentMethod.type)
            ) {
        ...
        <PageContainer>
                ...
                <div className="xl:col-span-2 space-y-6">
                    <CustomCard>
                        <CustomCardHeader>
                            ...
                            <CustomCardDescription>
                                Manage order status, payment, and customer
                                notifications
                            </CustomCardDescription>
                        </CustomCardHeader>
                        <CustomCardContent className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Changes apply immediately. Add notes in the
                                    order timeline to track updates.
                                </p>
                            </div>
                                                            ...
                                                            <td className="py-3">
                                                                <div className="flex items-start gap-3">
                                                                    ...
                                                                    <div className="flex flex-col">
                                                                        ...
                                                                        {attributeEntriesForDisplay.length >
                                                                            0 && (
                    ...
                    <CustomCard>
                        <CustomCardHeader>
                            ...
                            <CustomCardDescription>
                                Shipping labels or printed documents from the
                                pharmacy
                            </CustomCardDescription>
                        </CustomCardHeader>
                        <CustomCardContent className="space-y-3">
                            {pharmacyHardcopy.length === 0 ? (
                                <p className="text-sm text-muted-foreground">
                                    No pharmacy hardcopy attachments found for
                                    this order.
                                </p>
                            ) : (
                ...
                <div className="space-y-6">
                  ...
                  <>
                    ...
                    <div className="space-y-2">
                        ...
                        {resolvedDoctorOptions.length === 0 &&
                            !loadingDoctorOptions && (
                                <p className="text-xs text-muted-foreground">
                                    Focus the dropdown to load available
                                    doctors.
                                </p>
                            )}
                    </div>
            ...
            >
                <form onSubmit={handleShipSubmit} className="space-y-4">
                    ...
                    <p className="text-xs text-muted-foreground">
                        Updating status to <strong>SHIPPED</strong>. Tracking
                        number will be attached to the order if provided.
                    </p>
            ...
            >
                {paymentIntentLoading ? (
                    <LoadingState
                        message="Loading payment intent..."
                        ...
                        <div className="grid gap-3 md:grid-cols-2">
                            ...
                            {order.stripePaymentIntentStatus && (
                                <p className="text-muted-foreground">
                                    ...
                                    {order.stripePaymentIntentStatus.replace(
                                        /_/g,
                                        " "
                                    )}
                                </p>
                            ...
                            {paymentDetails.stripe?.stripeMeta
                                ?.paymentIntentId &&
                                paymentDetails.stripe.stripeMeta
                                    .paymentIntentId !==
                                    order.stripePaymentIntentId && (
