...
/**
 * Hook for fetching and managing subscriptions list with filtering and pagination
 * @param {Object} initialFilters - Optional initial filter values
 * @returns {Object} Subscriptions state and helpers
 */
export function useSubscriptions(initialFilters = {}) {
  ...
  /**
   * Fetch subscriptions from API using current filters
   */
