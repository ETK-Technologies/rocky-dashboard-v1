 ...
 * @param {Function} props.renderCustomRow - Function to render custom row content (row, rowId) => JSX | null
 * @param {Function} props.shouldHideRow - Function to check if row should be hidden (row, rowId) => boolean
 */
